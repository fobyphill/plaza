<%@ Page Title="Редактирование записей о планировании" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="edit_plan.aspx.cs" Inherits="plaza.edit_plan" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="onerow maincontent">
    ...
    <div class="mar10ver">
       ...
       <div class ="mar10ver">
           <asp:TextBox ID="tb_data_plan" runat="server" CssClass="border1" Width="310px" TextMode="Month"></asp:TextBox>
       ...
       <div class="mar10ver">
         <asp:Button CssClass="bluebutton" Height="30px" ID="b_save" runat="server" Text="Сохранить" OnClick="b_save_Click" />
            <asp:Button CssClass="greenbutton mar10hor" Height="30px" ID="b_cancel" runat="server" Text="Отмена" 
